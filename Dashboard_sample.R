...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Mental Health", tabName = "Mental Health", icon=icon("dashboard"))
      )
  ),
    ...
    #Defining what is going on each of the tabs
      ...
      tabItem(tabName="Technology",
        ...
        fluidRow(
          ...
          box(plotlyOutput("gdp_world"), width=12, sliderInput(inputId = "year_gdp", "Year", min=1, max=27, value=1))
              )),
      #Technology Adoption
      tabItem(
